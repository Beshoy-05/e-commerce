        ...
        <div className="row align-items-center g-5">
          <div className="col-lg-6">
            ...
            <p className="text-secondary">
              Our platform was built to make online shopping easier, faster, and
              more enjoyable. We offer a wide range of carefully selected
              products that combine quality, affordability, and modern design.
            </p>

            <p className="text-secondary">
              From browsing to checkout, we focus on creating a smooth shopping
              experience with trusted products and excellent customer service.
            </p>
